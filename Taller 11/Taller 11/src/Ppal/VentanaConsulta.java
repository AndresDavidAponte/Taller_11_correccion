...
public class VentanaConsulta extends JDialog{
    ...
    private String titulos[]={"isbn", "titulo", "autor", "anio", "costo"};
    
    private GestionPublicacion negocio;

    VentanaConsulta(JFrame frame, boolean bln) {
        super(frame, bln);
    ...
    public void actualizarTabla(List<Publicacion> lista){
            ...
            for(Publicacion publicacion: lista){
                String fila[] = {publicacion.getIsbn(), publicacion.getAutor(), ""+publicacion.getTitulo(),
                                 ""+publicacion.getCosto(), ""+publicacion.getAnio()};
    ...
    public void filtrarDatosTabla(){
        try {
            ...
            List<Publicacion> listaFiltrada = this.negocio.consultarp(texto);
